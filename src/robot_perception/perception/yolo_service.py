...
class YoloService:
    ...
    def detect_obstacles(self, frame_bgr: np.ndarray) -> List[DetectedObject]:
        """Filtruje obiekty, które mogą stanowić przeszkody."""
        obstacle_labels = {
            "chair", "bench", "potted plant", "tv", "couch", "table",
            "bottle", "cup", "backpack", "box", "person"
        }
        return [d for d in self.detect(frame_bgr) if d.label in obstacle_labels]

    # TODO: dodać progi klasowe i strefy bezpieczeństwa zależne od robota.
